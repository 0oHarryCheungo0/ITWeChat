...
<div style="padding-left: 20px;padding-right: 20px;padding-top: 20px;">
    <div class="layui-form  layui-form-pane">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <textarea name="response_text" placeholder="回复内容" class="layui-textarea" id="response_text"></textarea>
                <div class="layui-img-list" id="response_source_ids">
                </div>
                <button class="layui-btn reply-resource" id='response_resource' style="display: none">
...
//            layer.msg(JSON.stringify(data.field));
            ...
            $.post("<?=Url::to(['wechat-reply/save'])?>", {json: json}, function (ret) {
                if (ret.code == 0) {
