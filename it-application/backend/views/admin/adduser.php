<form action="index.php?r=admin/adduser" method="post">
	...
	密码:<input type="text" name="password_repeat"><br/>
...
<fieldset class="layui-elem-field layui-field-title  layui-box" style="margin-top: 50px;">
    <legend>方框风格的表单集合</legend>
</fieldset>
<div class="container-fluid">
    <div class="col-md-6">
        <form class="layui-form layui-form-pane  layui-box admin-position-btn-box" action="">
            <div class="layui-form-item">
