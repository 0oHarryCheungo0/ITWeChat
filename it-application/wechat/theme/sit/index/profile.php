...
<div class="bodyMain">
    <div class="mainBox">
        ...
        <div class="mainCss mainborImg">
            <img src="/public/sit/images/top_03.png">
        </div>

        <div class="personal mainbor">

            <div class="personalMain personalInput">
                <div class="left per_e5508b" style="width:44%;padding-right:12%;">
                    <p><?= Yii::t('app', '名字') ?><span>必填</span></p>
                    <input class="weui-input" type="text" id="name" placeholder="<?= Yii::t('app', '请输入名字'); ?>"
                           value="<?= $vip['name_first'] ?>">
                </div>
                <div class="left per_e5508b" style="width:44%;">
            ...
            <div class="personalMain per_af4be1">
            ...
            <div class="personalMain per_ef801e">
                <p><?= Yii::t('app', '手机号码') ?></p>
                <input class="weui-input" type="tel" id="tel" placeholder="请输入手机号码" value='<?= $vip['phone'] ?>'
                       disabled>
            </div>
            <div class="personalMain per_f3c920">
                <p><?= Yii::t('app', '电子邮箱') ?><span>必填</span></p>
                <input class="weui-input" type="email" id="email" placeholder="<?= Yii::t('app', '请输入邮箱地址') ?>"
                       value='<?= $vip['email'] ?>'>
            </div>
            <div class="p_t"
                 style="padding-left: 10px"><?= Yii::t('app', '邀请您填写更多个人信息，以便我们为您提供个性化服务，更可获赠i.t微信会员积分。') ?></div>
            <div class="personalBox personalMain">
                ...
                <div class="personalMain noPadd per_0065ff">
                ...
                <div class="personalMain noPadd per_27b947">
                ...
                <div class="personalMain noPadd per_ef801e ">
...
<script src="/public/sit/js/paperfold.min.js"></script>
<script src="/public/sit/js/distpicker.data.js"></script>
<script src="/public/sit/js/distpicker.js"></script>
...
<script src="/public/sit/js/personal-i.js"></script>
