...
<head lang="en">
    ...
    <title>NEWS</title>
    <link rel="stylesheet" href="http://wechat.itezhop.com/public/css/it.style.css"/>
    <link rel="stylesheet" href="http://wechat.itezhop.com/public/fonts/font.style.css"/>
    <link rel="stylesheet" href="http://wechat.itezhop.com/public/fonts/iconfont.css"/>
    <link rel="stylesheet" href="http://wechat.itezhop.com/public/css/pageCss.css"/>
    ...
    <ul class="news_info">
        ...
        if (!$data['data']['data']) {
            ...
            <div style="padding-top:30%;text-align: center;font-size:16px;color: #8a8a8a;">
                <img src="http://wechat.itezhop.com/public/images/notk.png" style="width:108px;">
...
<div class="singUp-bt">
    <img src="http://wechat.itezhop.com/public/images/bottom2.png">
</div>
</div>
<script src="http://wechat.itezhop.com/public/js/jquery.min.js"></script>
<script>
